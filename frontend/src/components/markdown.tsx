...
import MarkdownLink from "./markdown/markdown-link";
import MarkdownSummary from "./markdown/markdown-summary";
  ...
  return (
    <div className={cn("markdown-body", compact ? "markdown-body-compact" : "")}>
      <ReactMarkdown
        remarkPlugins={[
          [remarkMath, {}],
          [remarkLuoguFlavor, { linkOriginalUrl: originalUrl ?? "https://www.luogu.com.cn/" }],
        ]}
        rehypePlugins={[
          rehypeKatex,
